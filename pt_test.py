...
class InteractiveSignalViewer:
    ...
    def update_plot(self):
        ...
        patient_id, timestamps, rppg_signal, ecg_signal = self.data_list[self.current_index]
        self.current_patient_id = patient_id
        
        print(f"\nPatient ID: {patient_id} [{self.current_index + 1}/{len(self.data_list)}]")
        ...
        self.fig.suptitle("Press 'y' to accept, 'n' to reject, 'q' to quit", fontsize=12, fontweight='bold')
...
if __name__ == '__main__':
    ...
    viewer = InteractiveSignalViewer(list(cleaned_data))
